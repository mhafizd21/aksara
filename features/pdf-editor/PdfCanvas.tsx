...
export function PdfCanvas() {
  ...
  }, [isPlacingSignature, currentPage, pdfDoc, swipeOffset, setCurrentPage, placeSignatureAtPosition, getCanvasCoords]);
